...
module Searchkick
  ...
  class << self
    attr_accessor :search_method_name, :wordnet_path, :timeout, :models, :client_options, :redis, :index_prefix, :index_suffix, :queue_name, :searchkick_search_analyzer, :searchkick_search2_analyzer, :model_options
